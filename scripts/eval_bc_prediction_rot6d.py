...
OUT_DIR = "/home/june/bimanual_handover_IL/checkpoints/bc_rot6d/eval"
...
def main():
    ...
    key_rows_csv = os.path.join(OUT_DIR, "eval_rows_phase145.csv")
    key_df.to_csv(key_rows_csv, index=False)

    # Save summary table
    table1_csv = os.path.join(OUT_DIR, "table1_phase145_summary.csv")
    table1_df = save_phase_summary_table(key_df, table1_csv)

    # Make figure 1
    figure1_png = os.path.join(OUT_DIR, "figure1_gt_vs_pred_xyz_phase145.png")
    make_figure1(key_df, figure1_png)

    # Console summary
    print("\n===== TABLE 1: OFFLINE PREDICTION SUMMARY (PHASE 1/4/5) =====")
