...
# round3 checkpoint
MODEL_PATH = "/home/june/bimanual_handover_IL/checkpoints/bc_rot6d_round3/last.pt"
...
# round3 rollout evaluation logs
SAVE_DIR = "/home/june/bimanual_handover_IL/data/rollout_bc_rot6d_round3_eval"
...
print("[INFO] round3 model loaded")
...
def run_one_episode(ep_idx):
    ...
    csv_path = os.path.join(
        SAVE_DIR,
        f"round3_rollout_phase4_zonly_ori_fixed_ep{ep_idx:03d}_{int(time.time())}.csv"
    )
